  ...
  return (
    <>
      <PageHeader
        ...
        actions={<button className="button" type="button">カテゴリを追加</button>}
      />
        ...
        <div className="card panel">
          ...
          <div className="settings-list">
            <div className="settings-row">
              ...
              <button className="button secondary" type="button">編集</button>
            </div>
            <div className="settings-row">
              <div>
                <h2>未分類の扱い</h2>
                <p>自動分類できない取引は明細一覧で確認します。</p>
              </div>
              <button className="button secondary" type="button">確認</button>
            </div>
          </div>
        </div>
      </section>
