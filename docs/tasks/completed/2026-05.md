...
- [x] `project-rules.md` を薄い入口へ再編する
  - 対応: `docs/specs/project-rules/README.md` を入口文書へ再構成し、`docs/specs/development-workflow/README.md` と `docs/architecture/principles/README.md` を新設した。あわせて、共通要件の一部を `domain-model.md`、`api-specs.md`、`security.md`、`pdf-import.md`、`docs/requirements/` へ移し、`docs/README.md`、`README.md`、`AGENTS.md`、`docs/tests/e2e/README.md` の参照導線を更新した。
