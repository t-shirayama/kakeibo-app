...
- 収入設定、予算管理
- 月次ダッシュボード、カテゴリ別・月別・週別・年別集計
- Excel（`.xlsx`）エクスポート
- JWT認証、CSRF、パスワードリセット
- 監査ログ
...
![ダッシュボード](docs/designs/screens/dashboard.png)

### 予算管理

![予算管理](docs/designs/screens/budgets.png)

### カレンダー

![カレンダー](docs/designs/screens/calendar.png)

### 明細一覧

![明細一覧](docs/designs/screens/transactions.png)

### 明細編集モーダル

![明細編集モーダル](docs/designs/screens/transaction-edit-modal.png)

### 収入設定

![収入設定](docs/designs/screens/income-settings.png)

### アップロード

![アップロード](docs/designs/screens/upload.png)

### カテゴリ管理

![カテゴリ管理](docs/designs/screens/categories.png)

### 監査ログ

![監査ログ](docs/designs/screens/audit-logs.png)

### 設定

![設定](docs/designs/screens/settings.png)
...
- [プロダクトビジョン](docs/product/vision/README.md)
