...
OPERATIONS = [
    ...
    {"name": "list_category_rules", "method": "get", "path": "/api/category-rules"},
    {"name": "create_category_rule", "method": "post", "path": "/api/category-rules"},
    {"name": "update_category_rule", "method": "put", "path": "/api/category-rules/{rule_id}"},
    {"name": "set_category_rule_active", "method": "patch", "path": "/api/category-rules/{rule_id}/status"},
    {"name": "delete_category_rule", "method": "delete", "path": "/api/category-rules/{rule_id}"},
