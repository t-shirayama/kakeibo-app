...
description: Use when updating current application screenshots in docs/designs, refreshing README screen-image sections, or maintaining frontend/e2e/docs-screenshots.spec.ts for this repository.
---
...
Use this skill whenever the work involves current screen screenshots under `docs/designs/`, including adding screens, re-shooting images, replacing current PNG files, or syncing README image references.
